...
const HeroesList = ({ }) => {
  ...
  */
  async function getHeroes() {
    ...
    if (state && data.data && data.data.results) {
                  ...
                  <tr id={hero.id}>
                    ...
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-10 w-10">
                        <img className="h-10 w-10 rounded-full" src={`${hero.thumbnail?.path}.${hero.thumbnail?.extension}`} alt="" />
                      </div>
                      <div className="ml-4">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{hero.description}</div>
